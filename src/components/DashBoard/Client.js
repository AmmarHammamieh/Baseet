...
import Clien from "../../images/Clients.svg";
    ...
    <div className='w-full h-full'>
        ...
        <div className='flex bg-[#F5F7F9]'> 
           ...
           <div className='flex m-auto items-center w-3/4 mt-10 bg-[#FAF9FB] rounded-full border-0 shadow-md  '>
              ...
              <SearchBarClients placeholder="...ابحث عن العميل" SetClients={SetClients} Clients={Clients} />
                  </div>
              {console.log(Clients,"cli")}
              <ClientsTable itemsPerPage={10} Data={Clients} />
          </div>
           {/* side */}
