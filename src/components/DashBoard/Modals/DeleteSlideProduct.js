...
export default function DeleteSlideProduct({DeleteId,open,setOpen}) {
    console.log(DeleteId,"adsfafaq");
...
async function Delete() {
    let Data = {
      ...
      await axios.post(`http://127.0.0.1:8000/api/DashBoard/ProductSlides/DeleteSlide`, Data)
        .then(res => {
    ...
    console.log(DeleteId);
      await axios.post(`http://127.0.0.1:8000/api/DashBoard/ProductSlides/getSlide`, Data)
        .then(res => {
            ...
            console.log(res.data.slide,"hkhkj");
        });
                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        ...
                        ({Slide?.title}) هل أنت متأكد من رغبتك في حذف هذه الشريحة؟
                        </p>
                      </div>
                    </div>
                  </div>
