...
export default function DeleteImageSlide({DeleteId,open,setOpen}) {
...
async function Delete() {
    let Data = {
      ...
      await axios.post(`http://127.0.0.1:8000/api/DashBoard/ImageSlides/DeleteSlide`, Data)
        .then(res => {
                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        ...
                        ({Slide?.type}) هل أنت متأكد من رغبتك في حذف هذه الشريحة؟
                        </p>
                      </div>
                    </div>
                  </div>
