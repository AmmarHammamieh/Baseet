...
function Items({ currentItems}) {
       ...
       <table id='list' className=' w-3/4 mt-5 m-auto bg-white rounded-xl' >
        <tbody className=' '>
          <tr className='text-center border-b-2 '>
                      ...
                      <th className='p-3  border-l-2'>عنوانه</th>
                      <th className='p-3 border-l-2' > العمر</th>
                      <th className='p-3 border-l-2'> الجنس </th>
                      <th className='p-3 border-l-2'>اسم العميل</th>
                  </tr>
 ...
 <td className='p-3 border-l-2'>{item.address?item.address:'-'}</td>
  <td className='p-3 border-l-2'>{item.age}</td>
  <td className='p-3 border-l-2'>{item.gender}</td>
  <td className='p-3 border-l-2'>{item.name}</td>
...
function ClientsTable({ itemsPerPage, Data }) {
